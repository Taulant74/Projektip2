...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateQuery = "UPDATE mwcontenders SET Name='$newName', Wins='$newWins', Losses='$newLosses', Draws='$newDraws' WHERE ID=$fighterId";
    mysqli_query($conn, $updateQuery);
}

$fighterId = $_GET['id'];
$query = "SELECT * FROM mwcontenders WHERE ID=$fighterId";
