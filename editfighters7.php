...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateQuery = "UPDATE bwcontenders SET Name='$newName', Wins='$newWins', Losses='$newLosses', Draws='$newDraws' WHERE ID=$fighterId";
    mysqli_query($conn, $updateQuery);
}

$fighterId = $_GET['id'];
$query = "SELECT * FROM bwcontenders WHERE ID=$fighterId";
